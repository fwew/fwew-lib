...
func (w *Word) suffix(target string, previousAttempt string) string {
	...
	const (
		...
		nSufRe string = "(nga'|tsyìp|tu|fkeyk)?(o)?(pe)?(mungwrr|kxamlä|tafkip|pxisre|pximaw|ftumfa|ftuopa|mìkam|nemfa|takip|lisre|talun|krrka|teri|fkip|pxaw|pxel|luke|rofa|fpi|ftu|kip|vay|lok|maw|sìn|sre|few|raw|kam|kay|nuä|sko|yoa|ken|äo|eo|fa|hu|ka|mì|na|ne|ta|io|uo|ro|wä|ìlä|ìri|ìl|eyä|yä|ä|it|ri|ru|ti|ur|l|r|t)?(to|sì)?$"
		ngey   string = "ngey"
	)
